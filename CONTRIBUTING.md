...
- [Getting Started](#getting-started)
  ...
  - [Environment Setup](#environment-set-up-and-running-tests)
  - [Technical Requirements](#technical-requirements)
- [Development Workflow](#when-contributing-general-workflow)
  - [Branching Strategy](#when-creating-branches)
  - [Code Review Process](#code-review-process)
  - [Pull Request Submission](#submitting-a-pull-request)
